...
def faceDetectorService(showvideo):
    ...
    video_capture = cv2.VideoCapture("rtsp://%s:%s@%s:554/CH001" %(settings["user"],settings["password"],settings["ip"]))
